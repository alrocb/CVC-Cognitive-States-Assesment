...
expName = 'testMonitor'  # from the Builder filename that created this script
expInfo = {
    'participant': '01',
    'age': '',
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Alex\\Desktop\\CVC\\PyschoPy Files\\DEMO 1\\intropy_demo.py',
